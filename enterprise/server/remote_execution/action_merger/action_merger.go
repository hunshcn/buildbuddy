...
var (
	...
	hedgedActionCount   = flag.Int("remote_execution.hedged_action_count", 1, "TODO(iain)")
)

// current setup:
// pendingExecution/USER/actionDigest ==> executionID
// pendingExecutionDigest/executionID ==> pendingExecution/USER/actionDigest
